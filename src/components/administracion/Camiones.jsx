...
import CamionCard from '@/components/cards/CamionCard';
...
const Camiones = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Encabezado */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-800 mb-2">Gestión de Camiones</h1>
        <p className="text-slate-500">Administra los camiones disponibles para tus proyectos</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div className="w-full md:w-1/2 lg:w-1/3">
          <SearchBar
            placeholder="Buscar camión por placa, marca o modelo..."
            value={searchTerm}
